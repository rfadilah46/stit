...
class StudyProgramController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        //update study program, masukkan semua name, description, faculty_id, head_of_study_program, study_program_code, study_program_level, study_program_type, study_program_duration
        $studyProgram->name = $request->name;
        $studyProgram->description = $request->description;
        $studyProgram->faculty_id = $request->faculty_id;
        $studyProgram->head_of_study_program = $request->head_of_study_program;
        $studyProgram->study_program_code = $request->study_program_code;
        $studyProgram->study_program_level = $request->study_program_level;
        $studyProgram->study_program_type = $request->study_program_type;
        $studyProgram->study_program_duration = $request->study_program_duration;
        $studyProgram->save();
